...
class HomeViewController: UIViewController {
    ...
    @IBAction func VirtualTourClick(_ sender: AnyObject) {
        ...
        if !MyVariables.allSoldiersDownloaded {
           ...
           self.performSegue(withIdentifier: self.segueName, sender: nil)
            print("i moved to the view controler")
            //self.performSegue(withIdentifier: "VirtualMemorialSegue ", sender: self)
    ...
    func loadAnimation() {
        ...
        var imagesNames = ["run1.png", "run2.png", "run3.png", "run4.png", "run5.png", "run6.png", "run7.png", "run8.png", "run9.png", "run10.png", "run11.png"]
